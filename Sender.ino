...
char ssid[] = "Poco";    // your network SSID (name)
...
void setup() {
  ...
  if (!mqttClient.connect(broker, port)) {
    Serial.print("MQTT can not be connected !");
  ...
  Serial.println("Connection has been succesfully stablized with MQTT broker !");
  Serial.println();
  ...
  Serial.print("Waiting to recieve a message on the client : ");
  Serial.println(topic);
  Serial.println();
}
